...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  @override
  void initState() {
    Provider.of<PostController>(context, listen: false).getAllMyPosts(
        context: context, userId: FirebaseAuth.instance.currentUser!.uid);
    super.initState();
  }
                ...
                children: [
                  ...
                  ProfileScreenButton(
                      ...
                      subTitleColor: currentIndex == 1
                          ...
                          : AppColors.primaryBlack,
                      title:
                          userController.userModel.followers!.length.toString(),
                      subTitle: "Followers",
                  ...
                  ProfileScreenButton(
                      ...
                      subTitleColor: currentIndex == 2
                          ...
                          : AppColors.primaryBlack,
                      title:
                          userController.userModel.following!.length.toString(),
                      subTitle: "Following",
                      ...
                      child: StreamBuilder(
                        stream: FirebaseFirestore.instance
                            ...
                            .where(FieldPath.documentId,
                                whereIn: userController.userModel.followers)
                            .snapshots(),
                  ...
                  : SizedBox(
                      ...
                      child: StreamBuilder(
                        stream: FirebaseFirestore.instance
                            .collection('users')
                            .where(FieldPath.documentId,
                                whereIn: userController.userModel.following)
                            .snapshots(),
                        builder: (context, snapshot) {
                          if (!snapshot.hasData) {
                            return const Center(

...
class CommentScreen extends StatefulWidget {
  ...
  const CommentScreen({Key? key, this.postId, required this.postCreatorId})
      : super(key: key);
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      CommentModel commentModel =
                          CommentModel.fromDoc(snapshot.data!.docs[index]);
            ...
            Container(
              ...
              child: Padding(
                padding: const EdgeInsets.only(
                    left: 05, top: 5, right: 5, bottom: 5),
                child: Row(
                  children: [
                    CircleAvatar(
                      radius: 25,
                    ...
                    SizedBox(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            ...
                            hintText:
                                "comment as ${userController.userModel.username}",

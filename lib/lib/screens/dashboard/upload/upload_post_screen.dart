...
import 'package:chitchat/lib/screens/dashboard/upload/widgets/post_image_uploading_widget.dart';
import 'package:chitchat/lib/screens/dashboard/upload/widgets/post_video_uploading_widget.dart';
                            ...
                            return SizedBox(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Divider(thickness: 1, color: AppColors.primaryGrey),
                                  ListTile(
                                    onTap: () {
                                      setState(() {
                                        currentIndex = 1;

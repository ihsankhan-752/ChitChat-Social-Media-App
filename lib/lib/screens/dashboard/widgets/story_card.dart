                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              border: data['userCheckedList'].contains(FirebaseAuth.instance.currentUser!.uid)
                                  ? null
                ...
                Row(
                  children: [
                    IconButton(
                      ...
                      icon: Icon(Icons.arrow_back, color: AppColors.appCircularRadius),
                    ),
                    ...
                    IconButton(
                      ...
                      icon: Icon(Icons.abc_outlined, color: AppColors.appCircularRadius, size: 35),
                    ),
                  ],
                ),
                showTextField

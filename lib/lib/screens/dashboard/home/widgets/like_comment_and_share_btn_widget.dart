...
class LikeCommentShareButtonWidget extends StatelessWidget {
  ...
  final int index;
  const LikeCommentShareButtonWidget({super.key, required this.postController, required this.index});
    ...
    return Column(
      children: [
        CustomNeumorphicButton(
          title: "",
          icon: postController.postList[index].likes.contains(FirebaseAuth.instance.currentUser!.uid)
              ? Icons.favorite
              : Icons.favorite_border,
          iconColor: postController.postList[index].likes.contains(FirebaseAuth.instance.currentUser!.uid)
              ? Colors.red
              : Colors.grey,
          onPressed: () async {
